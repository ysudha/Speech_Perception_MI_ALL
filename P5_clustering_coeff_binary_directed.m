...
% windows 1 to 10, 11:16, 16 to rest, for each of the conditions
...
mat1 = sum(cluscoef1([1 3 4 8 12 13],[11:20]),2);
mat2 = sum(cluscoef2([1 3 4 8 12 13],[11:20]),2);
mat3 = sum(cluscoef3([1 3 4 8 12 13],[11:20]),2);
[mat1 mat2 mat3]

mat1 = sum(cluscoef1([1 3 4 8 12 13],[11:end]),2);
mat2 = sum(cluscoef2([1 3 4 8 12 13],[11:end]),2);
mat3 = sum(cluscoef3([1 3 4 8 12 13],[11:end]),2);
[mat1 mat2 mat3]
