...
mi_matrix_VOT456_K4 = cell(22,1);
for patient_number = 1:22
    if patient_number<22
        bin1 = 30; bin2 = 31; bin3 = 32;
    ...
    nwins = [[1:25:51] [101:25:326]]; % these are the start time of each window
    ...
    mi_matrix_VOT456_K4{patient_number,1}= mi_matrix;
    save('mi_matrix_VOT456_smallwin.mat','mi_matrix_VOT456_K4', '-v7.3'); %with mem 2
