...
%%%%%%%%%%% saving the data%%%%%%%%%%%%%%%%%%%%%%%%%%%%
RPCA_pos_neg.energy_S_mid_gt_high = energy_S_mid_gt_high;
RPCA_pos_neg.energy_S_mid_less_high = energy_S_mid_less_high;
RPCA_pos_neg.energy_S_mid_gt_low=energy_S_mid_gt_low;
RPCA_pos_neg.energy_S_mid_less_low = energy_S_mid_less_low;
RPCA_pos_neg.energy_S_low_gt_high = energy_S_low_gt_high;
RPCA_pos_neg.energy_S_low_less_high = energy_S_low_less_high;

save('RPCA_pos_neg','RPCA_pos_neg','-v7.3');
%% plotting (1)
load('RPCA_pos_neg');

X1 = RPCA_pos_neg.energy_S_mid_gt_high(:,1:end);
X2 = RPCA_pos_neg.energy_S_mid_less_high(:,1:end);
...
X1 = RPCA_pos_neg.energy_S_mid_less_low(:,1:end);
X2 = RPCA_pos_neg.energy_S_mid_gt_low(:,1:end);
ntim = ([101:5:301]-101)*2;
...
X1 = RPCA_pos_neg.energy_S_low_less_high(:,1:end);
X2 = RPCA_pos_neg.energy_S_low_gt_high(:,1:end);
ntim = ([101:5:301]-101)*2;
