...
mi_matrix_VOT789_K4 = cell(22,1);
for patient_number = 1:22
    if patient_number<22
        bin1 = 33; bin2 = 34; bin3 = 35;
    ...
    mi_matrix_VOT789_K4{patient_number,1}= mi_matrix;
    save('mi_matrix_VOT789_smallwin.mat','mi_matrix_VOT789_K4', '-v7.3'); %with mem 2
